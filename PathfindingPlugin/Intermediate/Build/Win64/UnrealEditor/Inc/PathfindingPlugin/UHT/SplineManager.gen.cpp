...
// Begin Class ASplineManager Function RemoveSelectedSplinePoint
struct Z_Construct_UFunction_ASplineManager_RemoveSelectedSplinePoint_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "CallInEditor", "true" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASplineManager_RemoveSelectedSplinePoint_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASplineManager, nullptr, "RemoveSelectedSplinePoint", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASplineManager_RemoveSelectedSplinePoint_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASplineManager_RemoveSelectedSplinePoint_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_ASplineManager_RemoveSelectedSplinePoint()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ASplineManager_RemoveSelectedSplinePoint_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ASplineManager::execRemoveSelectedSplinePoint)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->RemoveSelectedSplinePoint();
	P_NATIVE_END;
}
// End Class ASplineManager Function RemoveSelectedSplinePoint
...
void ASplineManager::StaticRegisterNativesASplineManager()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "RemoveSelectedSplinePoint", &ASplineManager::execRemoveSelectedSplinePoint },
...
struct Z_Construct_UClass_ASplineManager_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ASplineManager_RemoveSelectedSplinePoint, "RemoveSelectedSplinePoint" }, // 1378278820
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PathfindingTest_Plugins_PathfindingPlugin_Source_PathfindingPlugin_Public_SplineManager_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASplineManager, ASplineManager::StaticClass, TEXT("ASplineManager"), &Z_Registration_Info_UClass_ASplineManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASplineManager), 784623270U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PathfindingTest_Plugins_PathfindingPlugin_Source_PathfindingPlugin_Public_SplineManager_h_355902566(TEXT("/Script/PathfindingPlugin"),
	Z_CompiledInDeferFile_FID_PathfindingTest_Plugins_PathfindingPlugin_Source_PathfindingPlugin_Public_SplineManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PathfindingTest_Plugins_PathfindingPlugin_Source_PathfindingPlugin_Public_SplineManager_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
